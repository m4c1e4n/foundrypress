      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-[#0B1B3D] leading-[1.15] font-semibold">
            ...
            <div className="pt-6 border-t border-slate-200">
              <blockquote className="font-serif text-2xl md:text-3xl italic text-[#0B1B3D] tracking-tight">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-xs space-y-6">
              ...
              <div className="bg-[#F8FAFC] border border-slate-200 p-6 rounded-xl font-serif relative">
                <div className="text-[#16A34A] text-[11px] font-sans tracking-[0.2em] uppercase font-semibold mb-3">
                  Chapter 3 • Page 42
                </div>
                <p className="text-sm md:text-base text-slate-800 leading-relaxed italic first-letter:text-3xl first-letter:font-bold first-letter:float-left first-letter:mr-2 first-letter:text-[#0B1B3D]">
