    ...
    <section id="contact" className="py-16 sm:py-24 lg:py-32 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="max-w-3xl mb-12 sm:mb-16 space-y-4">
          ...
          <h2 className="font-serif text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-[#0B1B3D] font-semibold tracking-tight leading-[1.12]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16">
            ...
            {submitted ? (
              <div className="py-8 sm:py-12 text-center space-y-5 animate-in fade-in duration-300">
                ...
                <div>
                  <button
                    ...
                    className="mt-2 text-xs font-semibold uppercase tracking-[0.18em] text-[#16A34A] hover:underline cursor-pointer min-h-[44px]"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    <label className="block text-xs uppercase tracking-[0.18em] font-semibold text-[#0B1B3D] mb-2">
                      Full Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-3 bg-white border border-slate-200 rounded-lg text-base sm:text-sm text-slate-900 focus:outline-none focus:border-[#0B1B3D] transition-colors min-h-[44px]"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-white border border-slate-200 rounded-lg text-base sm:text-sm text-slate-900 focus:outline-none focus:border-[#0B1B3D] transition-colors resize-none"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full py-4 bg-[#16A34A] hover:bg-[#15803D] text-white text-xs uppercase tracking-[0.2em] font-bold rounded-full shadow-md transition-all flex items-center justify-center gap-2 group cursor-pointer min-h-[44px]"
                >
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-10">
            ...
            <div className="space-y-6">
              <h3 className="font-serif text-3xl font-semibold text-[#0B1B3D]">
              ...
              <div className="space-y-4 text-sm font-sans-clean">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="font-semibold block text-[#0B1B3D]">Publishing Headquarters</span>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="font-semibold block text-[#0B1B3D]">Direct Editorial Line</span>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="font-semibold block text-[#0B1B3D]">WhatsApp Message</span>
                    <a
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="font-semibold block text-[#0B1B3D]">Inquiries & Submissions</span>
              ...
              <div className="pt-6 border-t border-slate-200">
                ...
                <div className="flex gap-4 text-xs font-semibold text-[#0B1B3D]">
                  <a href="#" className="hover:text-[#16A34A]">LinkedIn</a>
                  <span>•</span>
                  <a href="#" className="hover:text-[#16A34A]">X / Twitter</a>
                  <span>•</span>
                  <a href="#" className="hover:text-[#16A34A]">Instagram</a>
                  <span>•</span>
                  <a href="#" className="hover:text-[#16A34A]">Substack</a>
                </div>
              </div>
            </div>

            {/* Repeat CTA Card */}
            <div className="bg-[#0B1B3D] text-white p-8 rounded-2xl space-y-4 shadow-md border border-blue-900">
              ...
              <button
                ...
                className="w-full py-3.5 bg-[#16A34A] text-white hover:bg-[#15803D] font-bold text-xs uppercase tracking-[0.2em] rounded-full transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-xs"
              >
