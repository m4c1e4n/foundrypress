...
export const WhoWeArePage: React.FC<WhoWeArePageProps> = ({ onOpenConsultation }) => {
  return (
    <div className="pt-24 pb-16">
      {/* Page Header */}
      <div className="bg-[#0B1B3D] text-white py-16 px-6 lg:px-12 text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 text-[#16A34A] font-semibold text-xs tracking-[0.2em] uppercase">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-slate-50 border border-slate-200 rounded-2xl space-y-3">
              <div className="w-12 h-12 rounded-xl bg-[#0B1B3D] text-[#16A34A] flex items-center justify-center">
                <ShieldCheck className="w-6 h-6" />
              </div>
              <h3 className="font-serif font-bold text-xl text-[#0B1B3D]">100% Confidentiality</h3>
            ...
            <div className="p-8 bg-slate-50 border border-slate-200 rounded-2xl space-y-3">
              ...
              <h3 className="font-serif font-bold text-xl text-[#0B1B3D]">Archival Print Quality</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="p-8 bg-slate-50 border border-slate-200 rounded-2xl space-y-3">
              ...
              <h3 className="font-serif font-bold text-xl text-[#0B1B3D]">Ghana & Diaspora Reach</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="mt-16 bg-[#0B1B3D] text-white rounded-3xl p-8 sm:p-12 text-center space-y-6">
